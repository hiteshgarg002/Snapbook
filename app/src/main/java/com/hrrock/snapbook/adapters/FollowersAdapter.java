...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.MyHolder> {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        ImageView options, followStatus;
        LinearLayout nameUserNameLinear;
        AVLoadingIndicatorView dpProgress;

        MyHolder(View itemView) {
            super(itemView);
            dp = itemView.findViewById(R.id.dpOnFollowers);
            options = itemView.findViewById(R.id.optionsOnFollowers);
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.layout_followers_row, parent, false);
